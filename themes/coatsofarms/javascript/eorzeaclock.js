...
function EorzeaTime(){
 ...
 gameMonth++;
  ...
  if(gameMonth == 1){gameMonth = '<span class="eorzeatime3_ice">星1月</span>';}
  if(gameMonth == 2){gameMonth = '<span class="eorzeatime3_ice">霊1月</span>';}
  if(gameMonth == 3){gameMonth = '<span class="eorzeatime3_water">星2月</span>';}
  if(gameMonth == 4){gameMonth = '<span class="eorzeatime3_water">霊2月</span>';}
  if(gameMonth == 5){gameMonth = '<span class="eorzeatime3_wind">星3月</span>';}
  if(gameMonth == 6){gameMonth = '<span class="eorzeatime3_wind">霊3月</span>';}
  if(gameMonth == 7){gameMonth = '<span class="eorzeatime3_lightning">星4月</span>';}
  if(gameMonth == 8){gameMonth = '<span class="eorzeatime3_lightning">霊4月</span>';}
  if(gameMonth == 9){gameMonth = '<span class="eorzeatime3_fire">星5月</span>';}
  if(gameMonth == 10){gameMonth = '<span class="eorzeatime3_fire">霊5月</span>';}
  if(gameMonth == 11){gameMonth = '<span class="eorzeatime3_earth">星6月</span>';}
  if(gameMonth == 12){gameMonth = '<span class="eorzeatime3_earth">霊6月</span>';}
 gameYear = gameYear + '年 '
